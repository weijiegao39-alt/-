window.TravelerData = (() => {
  ...
  const bosses = [
    {
      id: "desire", name: "欲望魔神", image: "boss_desire.png", hp: 82,
    ...
    {
      id: "market", name: "市场先生", image: "boss_market.png", hp: 74,
    ...
    {
      id: "phantom", name: "旧日幻影", image: "boss_phantom.png", hp: 88,
    ...
    {
      id: "fakeResearch", name: "伪研究员", image: "npc_scholar.png", hp: 69,
    ...
    {
      id: "inertia", name: "惰性王", image: "hero.png", hp: 77,
  ...
  const npcs = [
    { id: "scholar", name: "灰烬研究员", image: "npc_scholar.png", role: "研究任务、数据库、PPT、行业逻辑", offer: "今日委托：燃气轮机数据库推进90分钟。", dialogue: ["研究不是看起来很忙。研究是留下可检验的文字、表格和假设。", "今天先不要追求完整框架，先推进一个真实字段。"], advice: "接受委托：90分钟研究 + 300字输出。" },
    { id: "forge", name: "铸火工匠", image: "npc_forge.png", role: "装备强化、任务奖励、现实契约", offer: "契约：完成300字输出后解锁研究院装备。", dialogue: ["装备不是送的，是现实行动烧出来的。", "你完成输出，我给你铸造；你只装修系统，我什么都不给。"], advice: "接受契约：完成今日日报结算，触发装备掉落。" },
    { id: "watcher", name: "守夜顾问", image: "boss_desire.png", role: "欲望急救、离屏训练、深夜防线", offer: "急救：先冷水洗脸，再做10个深蹲。", dialogue: ["夜里不要讲道理，夜里只执行流程。", "入口关掉，身体移动，幻想链条自然断。"], advice: "守夜流程：离屏、洗脸、深蹲、纸面记录。" },
    { id: "risk", name: "风控仲裁者", image: "boss_market.png", role: "交易纪律、复盘、仓位约束", offer: "禁令：无复盘，不开放交易观察。", dialogue: ["市场不欠你翻本机会。", "你可以错，但不能不复盘；可以慢，但不能满杠杆。"], advice: "风控流程：写复盘、限制看盘、冻结冲动加仓。" }
  ];
